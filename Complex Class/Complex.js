...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'Complex.wast';
  var wasmBinaryFile = 'Complex.wasm';
  var asmjsCodeFile = 'Complex.temp.asm.js';
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { __GLOBAL__sub_I_Complex_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });
...
Module['wasmTableSize'] = 9889;

Module['wasmMaxTableSize'] = 9889;
...
var real___GLOBAL__sub_I_Complex_cpp = asm["__GLOBAL__sub_I_Complex_cpp"]; asm["__GLOBAL__sub_I_Complex_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_Complex_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_Complex_cpp = Module["__GLOBAL__sub_I_Complex_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_Complex_cpp"].apply(null, arguments) };
